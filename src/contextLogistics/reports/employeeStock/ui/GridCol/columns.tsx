...
interface IParams {
    handleEditClick: (row: EmployeeStockENTITYFlat) => void;
...
export function getcolumns(params: IParams): GridColDef<EmployeeStockENTITYFlat>[] {
    const {
        handleEditClick,
        rows,
        fieldsToInclude,
    ...
    const finalColumns: GridColDef<EmployeeStockENTITYFlat>[] = [
        ...columnsBase,
        ...extraColumns,
        {
            field: 'actions',
...
export const generateColumnsFromEntity = (
    entityInstance: EmployeeStockENTITYFlat,
