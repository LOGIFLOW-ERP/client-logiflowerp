...
import { ProducType, WarehouseExitENTITY } from "logiflowerp-sdk";
...
export function useExportExcelWarehouseExit() {
    const { exportExcel, getCsvStringAndFilteredRows } = useExportExcel<WarehouseExitENTITY>()

    function exportExcelWarehouseExit(
        apiRef: RefObject<GridApiCommunity | null>,
        rows: WarehouseExitENTITY[]
    ) {
    ...
    return { exportExcelWarehouseExit }
}