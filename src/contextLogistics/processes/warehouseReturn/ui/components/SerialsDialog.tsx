...
import {
    useAddSerialWarehouseReturnMutation,
    useDeleteSerialWarehouseReturnMutation
} from '@shared/api'
...
export function SerialsDialog(props: IProps) {
    ...
    const [addSerial, { isLoading: isLoadingAddSerial }] = useAddSerialWarehouseReturnMutation()
    const [deleteSerial, { isLoading: isLoadingDeleteSerial }] = useDeleteSerialWarehouseReturnMutation()
    const [canWarehouseReturnDeleteSerialByID] = usePermissions([PERMISSIONS.PUT_WAREHOUSE_RETURN_DELETE_SERIAL_BY_ID])
            ...
            <Box sx={{ height: '50vh' }}>
                <DataGrid<StockSerialDTO>
                    ...
                    columnVisibilityModel={{
                        actions: canWarehouseReturnDeleteSerialByID
                    }}
                />
            </Box>
        </CustomDialog>
